...
import org.firstinspires.ftc.teamcode.TurretSystems.ExtremePrecisionFlywheel;
import org.firstinspires.ftc.teamcode.TurretSystems.ShooterInformation;
...
public class ExtremePrecisionFlywheelTuner extends LinearOpMode {
    ...
    public static double KP, KI, KD, KF, KV, KA, KS;
    public static double kPIDFUnitsPerVolt = 1;
    public static double I_MIN, I_MAX;
    ...
    public void runOpMode() {
        ...
        flywheel = new ExtremePrecisionFlywheel(hardwareMap, Constants.MapSetterConstants.leftFlywheelMotorDeviceName, Constants.MapSetterConstants.rightFlywheelMotorDeviceName);
        ...
        while (opModeIsActive()) {
            ...
            if (TUNING_STAGE != TUNING_STAGES.BURST_VELOCITY) flywheel.setVelocity(VELOCITY, true);
            else flywheel.setVelocityWithBurst(VELOCITY, BURST_VELOCITY, true);
            ...
            currentVoltage = flywheel.p + flywheel.i + flywheel.d + flywheel.f;
