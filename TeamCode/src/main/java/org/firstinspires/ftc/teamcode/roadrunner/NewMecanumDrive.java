...
public final class NewMecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 0.0009962640099626400996264009962640099;
        public double lateralInPerTick = 0.001430590978139905;
        public double trackWidthTicks = 7000;

        // feedforward parameters (in tick units)
        public double kS = 1.8;
        public double kV = 0.000097;
        public double kA = 0.000148 ;
        ...
        public double headingVelGain = 10; // shared with turn

        public void setGains(double axialGain, double lateralGain, double headingGain) {

            this.axialGain = axialGain;
            this.lateralGain = lateralGain;
            this.headingGain = headingGain;
        }
        public void setVelGains(double axialVelGain, double lateralVelGain, double headingVelGain) {
    ...
    public static volatile Params PARAMS = new Params();
    ...
    public NewMecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        leftFront = hardwareMap.get(DcMotorEx.class, Constants.MapSetterConstants.leftFrontMotorDeviceName);
