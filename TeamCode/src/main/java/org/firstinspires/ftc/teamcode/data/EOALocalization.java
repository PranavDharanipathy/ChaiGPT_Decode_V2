...
/// Used {@link com.qualcomm.robotcore.util.ReadWriteFile}
...
public class EOALocalization {
    ...
    public static Pose autoFormatToTeleFormat(Pose autoPose, Rev9AxisImuWrapped rev9AxisImuWrapped, double xOffset, double yOffset) {
        return new Pose(autoPose.getY() - 72 + xOffset, -autoPose.getX() + 72 + yOffset, rev9AxisImuWrapped.getYaw(AngleUnit.RADIANS));
    }
